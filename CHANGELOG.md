...
- Added a strict runtime-neutral profile and universal capability format.
- Added read-only Claude and Codex source inventory with section-level suggestions.
- Added profile capture, canonical personal-context suggestions, privacy gates, atomic export, and item-level consent for personal and restricted modules on both export and destination apply.
